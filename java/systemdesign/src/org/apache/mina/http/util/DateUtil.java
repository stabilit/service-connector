 ...
 * other headers. This class handles dates as defined by RFC 2section 3.3.1 as
 * well as some other common non-standard formats.
 * 
...
public class DateUtil {
	...
	/**
	 * Date format pattern used to parse HTTP date headers in RFC 1format.
	 */
	 ...
	 * Date format pattern used to parse HTTP date headers in RFC 1format.
	 */
	public static final String PATTERN_RFC1063 = "EEEE, dd-MMM-yy HH:mm:ss zzz";
	...
	private static final Collection DEFAULT_PATTERNS = Arrays
			.asList(new String[] { PATTERN_ASCTIME, PATTERN_RFC1063,
					PATTERN_RFC1123 });
	 ...
	 *            <code>startDate</code> to <code>startDate + years</code>. This
	 *            value may be <code>null</code>. When <code>null</code> is
	...
	/**
	 * Formats the given date according to the RFC 1pattern.
	 * 
	 * @param date
	 *            The date to format.
	 * @return An RFC 1formatted date string.
	 * 
	 * @see #PATTERN_RFC1123
	 */
