...
public class PerformanceOneClient {
	 ...
	 */
	public static PerformanceOneClient getInstance() {
		return perf;
	}
	...
	private void goKeepAlive(String server, int numberOfMsg) {
		...
		pool.execute(new EchoClientKeepAliveStarter(server, numberOfMsg));
	}
	...
	/**
	 * The Class EchoClientKeepAliveStarter.
	 */
	public class EchoClientKeepAliveStarter implements Runnable {
