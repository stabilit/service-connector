...
public class MinaHttpConnectionWithQueue implements IConnection {
	...
	public MinaHttpConnectionWithQueue() {
		this.url = null;
	...
	public class HttpClientHandler extends IoHandlerAdapter {
		...
		public void messageReceived(IoSession session, Object message) {
			...
			MinaHttpConnectionWithQueue.this.submitResponse(responseMessage);
		}
