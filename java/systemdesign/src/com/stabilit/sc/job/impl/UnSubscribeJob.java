...
public class UnSubscribeJob extends Job implements ISubscribe {
	
	private static final long serialVersionUID = -3453831059514423535L;

	public UnSubscribeJob(SubscribeJob subscribeJob) {
    	super("unsubscribe");
