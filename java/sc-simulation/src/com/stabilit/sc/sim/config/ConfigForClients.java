 ...
 * 
 */
package com.stabilit.sc.sim.config;
 ...
 * 
 */
public class ConfigForClients {

	private Properties props;
	private List<ClientConfig> clientConfigList;

	public ConfigForClients() {
		super();
	...
	public void load(String fileName) throws IOException {
		InputStream is = ConfigForClients.class.getResourceAsStream(".." + File.separatorChar + fileName);
