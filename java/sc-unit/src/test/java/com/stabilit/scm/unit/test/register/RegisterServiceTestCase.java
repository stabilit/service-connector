...
public class RegisterServiceTestCase extends SuperTestCase {
	...
	public void registerServiceCall() throws Exception {
		...
		String expectedScEntry = "publish-simulation:0 - publish-simulation_localhost/:7000 : 10|P01_RTXS_sc1:0|simulation:0 - simulation_localhost/:7000 : 10|P01_BCST_CH_sc1:0|";
