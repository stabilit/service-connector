 ...
 */
public class NettyAPITcpServerConnection implements ITcpServerConnection {
	...
	public NettyAPITcpServerConnection() {
		this.bootstrap = null;
		this.channel = null;
	}
	...
	public void create(ServerConnectionContext serverCtx) {
		...
		bootstrap.setPipelineFactory(new NettyAPITcpServerPipelineFactory(this));
	}
	...
	public SCMP sendAndReceive(SCMP scmp) throws Exception {
		...
		NettyAPITcpServerRequestHandler handler = channel.getPipeline().get(NettyAPITcpServerRequestHandler.class);
