 ...
 * 
 */
public class NettyHttpServerIdleHandler extends IdleStateHandler {
	 ...
	 */
	public NettyHttpServerIdleHandler(Timer timer, int timeoutSeconds, IKeepAliveHandler callback) {
