...
public class APIMultipleClientSubscribeCasc2Test extends APIMultipleClientSubscribeCasc1Test {

	public APIMultipleClientSubscribeCasc2Test() {
		APIMultipleClientSubscribeCasc1Test.setUp2CascadedServiceConnectorAndServer();
	}
	...
	public void t01_2ClientsReceiving10000Messages() throws Exception {
		...
		for (int i = 0; i < clientCtxs.length; i++) {
			ProcessCtx clientCtx = ctrl.startPublishClient(TestConstants.logbackCln, "client" + i, TestConstants.HOST, TestConstants.PORT_SC2_TCP, ConnectionType.NETTY_TCP,
	...
	public void t02_2ClientsReceiving500_10000MessagesDiffService() throws Exception {
		...
		ProcessCtx clientCtx = ctrl.startPublishClient(TestConstants.logbackCln, "client1", TestConstants.HOST, TestConstants.PORT_SC2_TCP, ConnectionType.NETTY_TCP, 10, 0,
				TestConstants.pubServerName1, 50, "f_subscribeReceive500Unsubscribe");

		ProcessCtx clientCtx2 = ctrl.startPublishClient(TestConstants.logbackCln, "client2", TestConstants.HOST, TestConstants.PORT_SC2_TCP, ConnectionType.NETTY_TCP, 10,
	...
	public void t10_10ClientsReceiving10000Messages() throws Exception {
		...
		ProcessCtx clientCtx10 = ctrl.startPublishClient(TestConstants.logbackCln, "client10", TestConstants.HOST, TestConstants.PORT_SC2_TCP, ConnectionType.NETTY_TCP, 10,
	...
	public void t11_3ClientsReceivingMessages() throws Exception {
		...
		ProcessCtx clientCtx3 = ctrl.startPublishClient(TestConstants.logbackCln, "client0", TestConstants.HOST, TestConstants.PORT_SC2_TCP, ConnectionType.NETTY_TCP, 10,
				0, TestConstants.pubServerName1, 50, "f_subscribeReceive10000Unsubscribe");
