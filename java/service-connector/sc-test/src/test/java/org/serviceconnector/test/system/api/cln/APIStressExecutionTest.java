...
public class APIStressExecutionTest extends APIStressExecutionCasc1Test {
	...
	public void t01_2Clients10000Messages() throws Exception {
		...
		for (int i = 0; i < clientCtxs.length; i++) {
			ProcessCtx clientCtx = ctrl.startSessionClient(TestConstants.logbackCln, "client" + i, TestConstants.HOST, TestConstants.PORT_SC0_TCP, ConnectionType.NETTY_TCP,
	...
	public void t160_10MBMessageExchange() throws Exception {
		ProcessCtx clientCtx = ctrl.startSessionClient(TestConstants.logbackCln, "client", TestConstants.HOST, TestConstants.PORT_SC0_TCP, ConnectionType.NETTY_TCP, 10, 0,
