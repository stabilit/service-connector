...
public class APIMultipleClientSubscribeTest extends APIMultipleClientSubscribeCasc1Test {
	...
	public void t02_2ClientsReceiving500_10000MessagesDiffService() throws Exception {
		...
		ProcessCtx clientCtx = ctrl.startPublishClient(TestConstants.logbackCln, "client1", TestConstants.HOST, TestConstants.PORT_SC0_TCP, ConnectionType.NETTY_TCP, 10, 0,
				TestConstants.pubServerName1, 50, "f_subscribeReceive500Unsubscribe");

		ProcessCtx clientCtx2 = ctrl.startPublishClient(TestConstants.logbackCln, "client2", TestConstants.HOST, TestConstants.PORT_SC0_TCP, ConnectionType.NETTY_TCP, 10,
	...
	public void t10_10ClientsReceiving10000Messages() throws Exception {
		...
		ProcessCtx clientCtx10 = ctrl.startPublishClient(TestConstants.logbackCln, "client10", TestConstants.HOST, TestConstants.PORT_SC0_TCP, ConnectionType.NETTY_TCP, 10,
