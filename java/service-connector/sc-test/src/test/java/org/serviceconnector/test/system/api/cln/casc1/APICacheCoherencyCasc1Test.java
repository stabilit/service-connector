...
public class APICacheCoherencyCasc1Test extends APISystemSuperCCTest {
	...
	/**
	 * Description 1: load initial data to cache (cid=700) 2 seconds expiration 2: wait until expiration time runs out 3: verify data is NOT in top level cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: load initial data to cache (cid=700) 4 seconds expiration 2: start cache guardian - publish 3 Appendix 3: verify callback retrieval - 3 appendix within 10sec
	 * 4: verify data is in top level cache 5: wait until expiration time runs out 6: verify data is NOT in top level cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: load initial data to cache (cid=700) 2: verify data is in top level cache 3: start cache guardian - publish 1 Remove 4: verify callback retrieval - 1 appendix
	 * within 5sec 5: verify data is NOT in top level cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: load initial data to cache (cid=700) 2 seconds expiration 2: verify data is in top level cache 3: start cache guardian - publish 3 Appendix 1 Remove 4: verify
	 * callback retrieval - 3 appendix within 10sec 5: verify callback retrieval - 1 remove within 10sec 6: verify data is NOT in top level cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: load initial data to cache (cid=700) for 1 hour 2: verify data is in top level cache 3: start cache guardian - publish 1 initial message 4: verify callback
	 * retrieval - 1 initial within 10sec 5: verify data is in top level cache Expectation: passes
	 */
	@Test
	public void t05_cc_initialLargeDataReplaceByInitialData() throws Exception {
		...
		inspectResponse = mgmtClient.inspectCache("700");
		this.checkCacheInspectString(inspectResponse, "success", SC_CACHE_ENTRY_STATE.LOADED, "700", "0", "700/0/0=0&", TestConstants.cacheGuardian1);
	}

	/**
	 * Description 1: load initial data to cache (cid=700) for 1 hour 2: verify data is in top level cache 3: start cache guardian - publish 3 Appendix 1 initial message 4: verify
	 * callback retrieval - 3 appendix within 10sec 5: verify callback retrieval - 1 initial within 10sec 6: verify data is in top level cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: load initial large data to cache (cid=700), static - no expiration time 2: verify data is in top level cache 3: start cache guardian - publish 1 Remove 4:
	 * verify callback retrieval - 1 remove within 5sec 5: verify data is NOT in top level cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: load initial large data to cache (cid=700), static - no expiration time 2: verify data is in top level cache 3: start cache guardian - publish 3 Appendix 4:
	 * verify callback retrieval - 3 appendix within 10sec 5: verify data is in top level cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: load initial large data to cache (cid=700), static - no expiration time 2: verify data is in top level cache 3: start cache guardian - publish 1 initial 4:
	 * verify callback retrieval - 1 initial within 10sec 5: verify data is NOT in top level cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: start cache guardian - publish 1 remove 2: verify callback retrieval - 1 remove within 10sec 3: verify data is NOT in top level cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: start cache guardian - publish 1 initial 2: verify callback retrieval - 1 initial within 10sec 3: verify data is NOT in top level cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: start cache guardian - publish 3 Appendix, no cacheId set! 2: verify callback retrieval - 3 appendix within 10sec 3: verify data is NOT in top level cache
	 * Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: load large data to cache (cid=700) - unmanaged 2: start cache guardian - publish 3 Appendix! 3: verify callback retrieval - 3 appendix within 10sec 4: verify
	 * data is NOT in top level cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: start cache guardian - publish 3 Appendix 2: verify callback retrieval - 3 appendix within 10sec 3: verify data is NOT in top level cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: load large data (10MB) to cache (cid=700) 2: start cache guardian - publish 50 large appendix 3: verify callback retrieval - 50 large appendix within 100sec
	 * 4: verify data is NOT in top level cache Expectation: passes
	 */
	@Test
	public void t13_cc_Publish50Appendix() throws Exception {
		...
		Map<String, String> inspectResponse = mgmtClient.inspectCache("700");
		this.checkCacheInspectString(inspectResponse, "success", SC_CACHE_ENTRY_STATE.LOADED, "700", "50",
	...
	/**
	 * Description 1: load small initial data to cache (cid=700) 2: verify data is in top level cache 3: start cache guardian - publish 1 small initial 4: verify callback retrieval
	 * - 1 small within 10sec 5: verify data is in top level cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: load small initial data to cache (cid=700) 2: verify data is in top level cache 3: start cache guardian - publish 1 large initial 4: verify callback retrieval
	 * - 1 initial within 10sec 5: verify data is in top level cache Expectation: passes
	 */
	@Test
	public void t15_cc_smallInitialLargeInitial() throws Exception {
		...
		// 5: verify data is in top level cache
		inspectResponse = mgmtClient.inspectCache("700");
		this.checkCacheInspectString(inspectResponse, "success", SC_CACHE_ENTRY_STATE.LOADED, "700", "0", "700/0/0=1&", TestConstants.cacheGuardian1);
	}

	/**
	 * Description 1: load small initial data to cache (cid=700) 2: verify data is in top level cache 3: start cache guardian - publish 10MB initial 4: verify callback retrieval -
	 * 1 initial within 10sec 5: verify data is in top level cache Expectation: passes
	 */
	@Test
	public void t16_cc_smallInitial10BMInitial() throws Exception {
		...
		// 5: verify data is in top level cache
		inspectResponse = mgmtClient.inspectCache("700");
		this.checkCacheInspectString(inspectResponse, "success", SC_CACHE_ENTRY_STATE.LOADED, "700", "0", "700/0/0=51&", TestConstants.cacheGuardian1);
	}

	/**
	 * Description 1: load large data (10MB) to cache (cid=700) 2: start cache guardian - publish 3 large Appendix (2 parts each) & 1 large initial 3: verify callback retrieval - 3
	 * appendix within 10sec 4: verify callback retrieval - 1 initial within 10sec 5: read data from cache and verify 6: verify data is in top level cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: load large data (10MB) to cache (cid=700) 2: start cache guardian - publish 1 small initial & 3 large Appendix (2 parts each) 3: verify callback retrieval - 1
	 * initial within 10sec 4: verify callback retrieval - 3 appendix within 10sec 5: read data from cache and verify 6: verify data is in top level cache Expectation: passes
	 */
	@Test
	public void t18_cc_10MBInitial1SmallInitial3LargeAppendix() throws Exception {
		...
		// 6: verify data is in top level cache
		Map<String, String> inspectResponse = mgmtClient.inspectCache("700");
		this.checkCacheInspectString(inspectResponse, "success", SC_CACHE_ENTRY_STATE.LOADED, "700", "3", "700/0/0=0&700/1/0=1&700/2/0=1&700/3/0=1&", TestConstants.cacheGuardian1);
	}

	/**
	 * Description 1: start cache guardian - publish Initials (10000 with 1sec delay, cid=700) 2: load large data (10MB) to cache (cid=700) 3: verify data is in top level cache
	 * Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: load data to cache (cid=700) 2: start cache guardian - publish 3 Appendix 3: verify callback retrieval - 3 appendix within 10sec 4: read data from cache and
	 * verify 5: verify data is in top level cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: load large data (10MB) to cache (cid=700) 2: start cache guardian - publish 3 Appendix 3: verify callback retrieval - 3 appendix within 10sec 4: read data
	 * from cache and verify 5: verify data is in top level cache Expectation: passes
	 */
	@Test
	public void t21_cc_readManagedData10MBInitial() throws Exception {
		...
		// 5: verify data is in top level cache
		Map<String, String> inspectResponse = mgmtClient.inspectCache("700");
		this.checkCacheInspectString(inspectResponse, "success", SC_CACHE_ENTRY_STATE.LOADED, "700", "3", "700/0/0=51&700/1/0=0&700/2/0=0&700/3/0=0&",
				TestConstants.cacheGuardian1);
	}

	/**
	 * Description 1: load large data (10MB) to cache (cid=700) 2: start cache guardian - publish 3 large Appendix (2 parts each) 3: verify callback retrieval - 3 appendix within
	 * 10sec 4: read data from cache and verify 5: verify data is in top level cache Expectation: passes
	 */
	@Test
	public void t22_cc_readManagedData10MBInitialLargeAppendix() throws Exception {
		...
		// 5: verify data is in top level cache
		Map<String, String> inspectResponse = mgmtClient.inspectCache("700");
		this.checkCacheInspectString(inspectResponse, "success", SC_CACHE_ENTRY_STATE.LOADED, "700", "3", "700/0/0=51&700/1/0=1&700/2/0=1&700/3/0=1&",
				TestConstants.cacheGuardian1);
	}

	/**
	 * Description: 1: load large data (10MB) to cache (cid=700) 2: start cache guardian - publish 1 large (10MB) Appendix 3: verify callback retrieval - 1 appendix within 100sec
	 * 4: read data from cache and verify 5: verify data is in top level cache Expectation: passes
	 */
	@Test
	public void t23_cc_readManagedData10MBInitial10MBAppendix() throws Exception {
		...
		// 5: verify data is in top level cache
		Map<String, String> inspectResponse = mgmtClient.inspectCache("700");
		this.checkCacheInspectString(inspectResponse, "success", SC_CACHE_ENTRY_STATE.LOADED, "700", "1", "700/0/0=51&700/1/0=51&", TestConstants.cacheGuardian1);
	}

	/**
	 * Description 1: load data to cache (cid=700) 2: start cache guardian - doing nothing 3: stop cache guardian - cache will clean up managed data 4: verify data is NOT in top
	 * level cache 5: verify data is NOT in any cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description: 1: load data to cache (cid=700) 2: start cache guardian - publish 3 large Appendix (2 parts each) 3: stop cache guardian - cache will clean up managed data 4:
	 * verify data is NOT in top level cache 5: verify data is NOT in any cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description: 1: start cache guardian - publish Appendix (10000 with 1sec delay, cid=700) 2: load 10MB to cache (cid=700) 3: verify response is correct 4: verify data is NOT
	 * in top level cache 5: stop cache guardian Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: load large data (10MB) to cache (cid=700) 2: verify data is in top level cache 3: start cache guardian - publish 1 large (50MB) Appendix 4: try reading data
	 * from cache - cache loading exception (appendix loading) 5: wait until appendix is loaded 6: verify data is in top level cache Expectation: passes
	 */
	@Test
	public void t27_cc_CacheLoadingExceptionLoadingAppendix() throws Exception {
		...
		// 6: verify data is in top level cache
		this.checkCacheInspectString(inspectResponse, "success", SC_CACHE_ENTRY_STATE.LOADED, "700", "1", "700/0/0=51&700/1/0=256&", TestConstants.cacheGuardian1);
	...
	/**
	 * Description: 01: cache managed message null body by sessionService1 02: start cache guardian - publish 3 appendix 03: verify callback retrieval - 3 appendixes within 10sec
	 * 04: verify data is in top level cache Expectation: passes
	 */
	@Test
	public void t28_cc_cacheMsgNullBodyPublish3Appendix() throws Exception {
		...
		// 4: verify data is in top level cache
		Map<String, String> inspectResponse = mgmtClient.inspectCache("700");
		this.checkCacheInspectString(inspectResponse, "success", SC_CACHE_ENTRY_STATE.LOADED, "700", "3", "700/0/0=0&700/1/0=0&700/2/0=0&700/3/0=0&", "cacheGuardian1");
	}

	/**
	 * Description: 01: connect new client2 to top level (cascaded) SC 02: load data to cache (cid=700) by client1 03: start cache guardian1 for client1 - do nothing 04: start
	 * cache guardian1 for client2 - publish 3 large appendix 05: verify callback of guardian1 retrieval - 3 appendix within 100sec 06: verify callback of guardian1 retrieval - 3
	 * appendix within 100sec 07: verify data is now in top level cache 08: stop cache guardian of client1 09: verify data is still now in top level cache 10: stop cache guardian
	 * of client2 11: verify data is now NOT in top level cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description: 01: connect new client2 to top level (cascaded) SC 02: load data to cache (cid=700) by client1 03: load data to cache (cid=600) by client2 04: start cache
	 * guardian1 for client2 - do nothing 05: start cache guardian1 for client1 - publish 3 large appendix, cid=700 06: verify callback of client1 guardian1 retrieval - 3 appendix
	 * within 10sec 07: verify callback of client2 guardian1 retrieval - 3 appendix within 10sec 08: verify data (cid=600) is now in top level cache 09: verify data (cid=700) is
	 * now in top level cache 10: restart cache guardian of client1 - publish 3 large appendix, different mask 11: verify callback of client1 guardian1 retrieval - 3 appendix
	 * within 10sec 12: verify callback of client2 guardian1 retrieval - 0 appendix within 3sec 13: verify data (cid=600) is now in top level cache 14: verify data (cid=700) is
	 * still in top level cache Expectation: passes
	 */
	@Test
	public void t31_cc_2Clients1Cache() throws Exception {
		...
		this.checkCacheInspectString(inspectResponse, "success", SC_CACHE_ENTRY_STATE.LOADED, "600", "3", "600/0/0=0&600/1/0=1&600/2/0=1&600/3/0=1&", TestConstants.cacheGuardian1);
	 ...
	 * guardian1 for client2 - do nothing 05: start cache guardian1 for client1 - publish 3 large appendix, cid=700 06: verify callback of client1 guardian1 retrieval - 3 appendix
	 * within 10sec 07: verify callback of client2 guardian1 retrieval - 3 appendix within 10sec 08: verify data (cid=600) is now in top level cache 09: verify data (cid=700) is
	 * now in top level cache 10: change subscription for client2 different mask 11: restart cache guardian of client1 - publish 3 large appendix, different mask 12: verify
	 * callback of client1 guardian1 retrieval - 3 appendix within 10sec 13: verify callback of client2 guardian1 retrieval - 0 appendix within 3sec 14: verify data (cid=600) is
	 * now in top level cache 15: verify data (cid=700) is still in top level cache Expectation: passes
	 */
	@Test
	...
	/**
	 * Description: 1: connect new client2 to top level (cascaded) SC 2: load data to cache (cid=700) by client1 3: start cache guardian1 - do nothing 4: start cache guardian2 -
	 * publish 3 large appendix 5: verify callback of guardian2 retrieval - 3 appendix within 100sec 6: verify callback of guardian1 retrieval - nothing retrieved 7: verify data is
	 * now in top level cache Expectation: passes
	 */
	@Test
	public void t33_cc_2Clients2Server1Cache() throws Exception {
		...
		// 7: verify data is now in top level cache
		Map<String, String> inspectResponse = guardianClient.inspectCache("700");
		this.checkCacheInspectString(inspectResponse, "success", SC_CACHE_ENTRY_STATE.LOADED, "700", "3", "700/0/0=0&700/1/0=1&700/2/0=1&700/3/0=1&", TestConstants.cacheGuardian2);
	}

	/**
	 * Description: 1: connect new client2 to top level (cascaded) SC 2: load data to cache (cid=700) by client1 3: start cache guardian1 - publish 3 large appendix 4: start cache
	 * guardian2 - publish 3 large appendix 5: verify callback of guardian1 retrieval - 3 appendix within 100sec 6: verify callback of guardian2 retrieval - 3 appendix within
	 * 100sec 7: verify data is now in top level cache Expectation: passes
	 */
	@Test
	public void t34_cc_2Clients2Server1Cache() throws Exception {
		...
		// 7: verify data is now in top level cache
		Map<String, String> inspectResponse = guardianClient.inspectCache("700");
		this.checkCacheInspectString(inspectResponse, "success", SC_CACHE_ENTRY_STATE.LOADED, "700", "3", "700/0/0=0&700/1/0=1&700/2/0=1&700/3/0=1&");
	}

	/**
	 * Description: 1: connect new client2 to top level (cascaded) SC 2: load data to cache (cid=700) by client1 3: start cache guardian1 - publish 3 large appendix 4: start cache
	 * guardian2 - publish 3 large appendix 5: verify callback of guardian1 retrieval - 30000 appendix within 420 secs Expectation: passes
	 */
	@Test
	...
	/**
	 * Description 1: load data to cache (cid=700) 2: start cache guardian - publish 3 Appendix 3: verify callback retrieval - 3 appendix within 10sec 4: read data from cache and
	 * verify, verify cached flag is set correctly Expectation: passes
	 */
	@Test
	...
	protected void checkCacheInspectString(Map<String, String> inspectResponse, String returnStr, SC_CACHE_ENTRY_STATE msgState, String cid, String nrOfApp, String partInfo,
			String cacheGuardian) {
	...
	protected void checkAppendices(SCMessage scMessage, int expectedNrOfApp) {
		...
		Assert.assertEquals("unexpected number of appendices found in managed data", expectedNrOfApp, managedMessage.getNrOfAppendixes());
		int i = 0;
