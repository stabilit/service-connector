...
/**
 * The Class SrvCreateSessionCommand. Responsible for validation and execution of server create session command. Allows creating session on backend server.
 *
 * @author JTraber
 */
public class SrvCreateSessionCommand extends SrvCommandAdapter {
	...
	/** The Constant LOGGER. */
	private static final Logger LOGGER = LoggerFactory.getLogger(SrvCreateSessionCommand.class);
