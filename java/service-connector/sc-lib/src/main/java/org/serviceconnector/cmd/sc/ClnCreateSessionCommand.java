...
/**
 * The Class ClnCreateSessionCommand. Responsible for validation and execution of creates session command. Command runs successfully if backend server accepts clients request and
 * allows creating a session. Session is saved in a session registry of SC.
 *
 * @author JTraber
 */
public class ClnCreateSessionCommand extends CommandAdapter {
	...
	/** The Constant LOGGER. */
	private static final Logger LOGGER = LoggerFactory.getLogger(ClnCreateSessionCommand.class);
