...
/**
 * The Class SrvDeleteSessionCommand. Responsible for validation and execution of server delete session command. Allows deleting session on backend server.
 *
 * @author JTraber
 */
public class SrvDeleteSessionCommand extends SrvCommandAdapter {
	...
	/** The Constant LOGGER. */
	private static final Logger LOGGER = LoggerFactory.getLogger(SrvDeleteSessionCommand.class);
	...
	public void run(IRequest request, IResponse response, IResponderCallback responderCallback) throws Exception {
		...
		try {
			...
			srvService.getCallback().deleteSession(scMessage, Integer.parseInt(reqMessage.getHeader(SCMPHeaderAttributeKey.OPERATION_TIMEOUT)));
