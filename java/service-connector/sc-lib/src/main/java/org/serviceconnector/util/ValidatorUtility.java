...
public final class ValidatorUtility {
	...
	public static void validateDateTime(String dateTimeString, SCMPError error) throws SCMPValidatorException {
		...
		try {
			...
			throw new SCMPValidatorException(SCMPError.HV_WRONG_LDT, dateTimeString + " should be=" + Constants.SCMP_FORMAT_OF_DATE_TIME);
		}
	}
	 ...
	 * Validate long.
	 *
	 * @param lowerLimitInc the lower inclusive limit
	 * @param longStringValue the integer string value to validate
	 * @param error the error to be thrown in case of an invalidation
	 * @throws SCMPValidatorException the SCMP validator exception
	 */
	 ...
	 * Validate long.
	 *
	 * @param lowerLimitInc the lower limit inclusive
	 ...
	 * @param lowerLimitInc the lower inclusive limit
	 * @param longStringValue the integer string value to validate
	 * @param upperLimitInc the upper inclusive limit
	 * @param error the error to be thrown in case of an invalidation
	 * @throws SCMPValidatorException the SCMP validator exception
	 */
	 ...
	 * @param lowerLimitInc the lower limit inclusive
	 * @param longValue the integer value
	 * @param upperLimitInc the upper limit inc
	 * @param error the error
	 * @throws SCMPValidatorException the SCMP validator exception
	 */
	public static void validateLong(long lowerLimitInc, long longValue, long upperLimitInc, SCMPError error) throws SCMPValidatorException {
		if (longValue < lowerLimitInc || longValue > upperLimitInc) {
			throw new SCMPValidatorException(error, "LongValue=" + longValue + " is not in range (" + lowerLimitInc + "-" + upperLimitInc + ")");
		}
	}
	 ...
	 *
	 * @param ipAddressListString the ip address list string
	 * @throws SCMPValidatorException the SCMP validator exception
	 */
	 ...
	 *
	 * @param lowerLimitInc the lower inclusive limit
	 * @param intStringValue the integer string value
	 * @param error the error to be thrown in case of an invalidation
	 * @throws SCMPValidatorException the SCMP validator exception
	 */
	 ...
	 *
	 * @param lowerLimitInc the lower inclusive limit
	 * @param intStringValue the integer string value to validate
	 * @param upperLimitInc the upper inclusive limit
	 * @param error the error to be thrown in case of an invalidation
	 * @throws SCMPValidatorException the SCMP validator exception
	 */
	 ...
	 * @param lowerLimitInc the lower limit inclusive
	 * @param intValue the integer value
	 * @param upperLimitInc the upper limit inclusive
	 * @param error the error
	 * @throws SCMPValidatorException the SCMP validator exception
	 */
	public static void validateInt(int lowerLimitInc, int intValue, int upperLimitInc, SCMPError error) throws SCMPValidatorException {
		if (intValue < lowerLimitInc || intValue > upperLimitInc) {
			throw new SCMPValidatorException(error, "IntValue=" + intValue + " is not in range (" + lowerLimitInc + "-" + upperLimitInc + ")");
		}
	}
	 ...
	 *
	 * @param minSizeInc the min size inc
	 * @param stringValue the string value
	 * @param maxSizeInc the max size inc
	 * @param error the error
	 * @throws SCMPValidatorException the SCMP validator exception
	 */
	 ...
	 *
	 * @param minSizeInc the minimum inclusive size
	 * @param stringValue the string value
	 * @param maxSizeInc the max inclusive size
	 * @param error the error
	 * @throws SCMPValidatorException the SCMP validator exception
	 */
	 ...
	 * Validate string length.
	 *
	 * @param minSizeInc the minimum size inclusive
	 * @param stringValue the string value
	 * @param maxSizeInc the max size inclusive
	 * @param error the error
	 * @throws SCMPValidatorException the sCMP validator exception
	 */
	public static void validateStringLength(int minSizeInc, String stringValue, int maxSizeInc, SCMPError error) throws SCMPValidatorException {
		...
		if (length < minSizeInc || length > maxSizeInc) {
			throw new SCMPValidatorException(error, "StringValue length=" + length + " is not in range (" + minSizeInc + "-" + maxSizeInc + ")");
		}
		byte[] buffer = stringValue.getBytes();
		for (byte element : buffer) {
			if (ValidatorUtility.isCharacterAllowed(element) == false) {
	 ...
	 *
	 * @param cachingMethod the caching method
	 * @param error the error
	 * @throws SCMPValidatorException the SCMP validator exception
	 */
