...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template name="sc_menu_left"><div class="sc_menu_item" onmouseover="javascript:setStyleOver(this)" onmouseout="javascript:setStyleOut(this)"><a class="sc_menu_item" href="./resource?name={$head/query/param/@name}"><xsl:value-of select="$head/query/param/@name"/></a></div></xsl:template>
</xsl:stylesheet>
