Readme File Uploader based on SC
...
java -jar fileUploader.jar localhost 9000 netty.tcp file-1 list
java -jar fileUploader.jar localhost 9000 netty.tcp file-1 upload send.txt sent.txt 3600
java -jar fileUploader.jar localhost 9000 netty.tcp file-1 download testRec.tar.gz eclipse-jee-juno.tar.gz 3600
