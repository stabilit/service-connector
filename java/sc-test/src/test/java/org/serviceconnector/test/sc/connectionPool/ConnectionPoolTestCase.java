...
public class ConnectionPoolTestCase {
	...
	public void testMinMaxWrong() throws Exception {
		ConnectionPool connectionPool = new ConnectionPool(TestConstants.HOST, TestConstants.PORT_TCP);
	...
	public void testKeepAliveInactive() throws Exception {
		ConnectionPool connectionPool = new ConnectionPool(TestConstants.HOST, TestConstants.PORT_TCP, 0);
		connectionPool.setMaxConnections(2);
	...
	public void testKeepAliveActive() throws Exception {
		ConnectionPool connectionPool = new ConnectionPool(TestConstants.HOST, TestConstants.PORT_TCP, 5);
	...
	public void testConnectionCloseAfterTenKeepAlive() throws Exception {
		ConnectionPool connectionPool = new ConnectionPool(TestConstants.HOST, TestConstants.PORT_TCP, 1);
		connectionPool.setMaxConnections(2);
		connectionPool.setMinConnections(2);
		connectionPool.initMinConnections();
		Thread.sleep(10000);
