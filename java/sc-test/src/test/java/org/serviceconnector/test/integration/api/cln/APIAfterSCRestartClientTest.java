...
public class APIAfterSCRestartClientTest extends APIIntegrationSuperClientTest {
	...
	public void t105_enableServiceAfterRestart() throws Exception {
		...
		Assert.assertEquals("Service is not enabled", Boolean.TRUE.toString(), client.isServiceEnabled(
				TestConstants.sesServiceName1).getParamValue(TestConstants.sesServiceName1));
	}
	...
	public void t106_disableServiceAfterRestart() throws Exception {
		...
		Assert.assertEquals("Service is not disabled", Boolean.FALSE.toString(), client.isServiceEnabled(
				TestConstants.sesServiceName1).getParamValue(TestConstants.sesServiceName1));
	}
	...
	public void t205_enableServiceAfterRestart() throws Exception {
		...
		client.enableService(TestConstants.sesServiceName1);
		Assert.assertEquals("Service is not enabled", Boolean.TRUE.toString(), client.isServiceEnabled(
				TestConstants.sesServiceName1).getParamValue(Constants.SERVICE_NAME));
	}
