...
public class APIMultipleClientSubscribeCasc2Test extends SystemSuperTest {
	...
	public APIMultipleClientSubscribeCasc2Test() {
		APIMultipleClientSubscribeCasc2Test.setUp2CascadedServiceConnectorAndServer();
	}

	@Before
	public void beforeOneTest() throws Exception {
		super.beforeOneTest();
		srvCtx = ctrl.startServerEnvironment(APIMultipleClientSubscribeCasc2Test.srvDefs);
	}
	...
	public static void setUpServiceConnectorAndServer() {
		...
		APIMultipleClientSubscribeCasc2Test.srvDefs = srvToSC0Defs;
	}
	...
	public static void setUp1CascadedServiceConnectorAndServer() {
		...
		APIMultipleClientSubscribeCasc2Test.srvDefs = srvToSC0CascDefs;
	}
	...
	public void t01_2ClientsReceiving10000Messages() throws Exception {
		...
		APIMultipleClientSubscribeCasc2Test.ctrl.waitForClientTermination(clientCtxs);
	...
	public void t02_2ClientsReceiving500_10000MessagesDiffService() throws Exception {
		...
		APIMultipleClientSubscribeCasc2Test.ctrl.waitForClientTermination(clientCtx);
		APIMultipleClientSubscribeCasc2Test.ctrl.waitForClientTermination(clientCtx2);
		// dont't check message.log might be an EXC because of broken CRP
		TestUtil.checkLogFile(TestConstants.log4jClnProperties, "client.log");
	}
