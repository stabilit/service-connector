...
public class APIAfterSCAbortReceivePublicationTest {

	/** The Constant testLogger. */
	protected static final Logger testLogger = Logger.getLogger(Loggers.TEST.getValue());
	/** The Constant logger. */
	protected final static Logger logger = Logger.getLogger(APIAfterSCAbortReceivePublicationTest.class);
	...
	private class MsgCallback extends SCMessageCallback {
		...
		public MsgCallback(SCService service) {
			super(service);
			APIAfterSCAbortReceivePublicationTest.messageReceived = false;
			response = null;
			messageCounter = 0;
			expectedMessages = 0;
		}
		...
		public void receive(SCMessage msg) {
			...
			if ( expectedMessages == messageCounter) {
				APIAfterSCAbortReceivePublicationTest.messageReceived = true;
			}
			if (((messageCounter+1) % 1000) == 0) {
				APIAfterSCAbortReceivePublicationTest.testLogger.info("Receiving message nr. " + (messageCounter+1));
			}
		}
