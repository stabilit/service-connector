...
public class APIMultipleClientSubscribeTest extends SystemSuperTest {
	...
	public APIMultipleClientSubscribeTest() {
		APIMultipleClientSubscribeTest.setUpCascadedServiceConnectorAndServer();
	}

	@Before
	public void beforeOneTest() throws Exception {
		super.beforeOneTest();
		srvCtx = ctrl.startServerEnvironment(APIMultipleClientSubscribeTest.srvDefs);
	}
	...
	public static void setUpServiceConnectorAndServer() {
		...
		APIMultipleClientSubscribeTest.srvDefs = srvToSC0Defs;
	}
	...
	public static void setUpCascadedServiceConnectorAndServer() {
		...
		APIMultipleClientSubscribeTest.srvDefs = srvToSC0CascDefs;
	}
