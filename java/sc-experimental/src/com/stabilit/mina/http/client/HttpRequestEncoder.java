...
public class HttpRequestEncoder extends ProtocolEncoderAdapter {
	...
	public void encode(IoSession ioSession, Object message,
		...
		try {
			...
			// Process cookies
			// NOTE: I am just passing the name value pairs and not doing
			// management of the expiration or path
			// As that will be left up to the user. A possible enhancement is to
			// make use of a CookieManager
