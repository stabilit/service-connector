...
public class NettyHttpServerPipelineFactory implements ChannelPipelineFactory {
	...
	public NettyHttpServerPipelineFactory(Class<? extends ISCServiceListener> scListenerClass,
	...
	public ChannelPipeline getPipeline() throws Exception {
		...
		writeTimeoutHandler = new NettyHttpServerWriteTimeoutHandler(new HashedWheelTimer(), writeTimeout,
				scListener);
