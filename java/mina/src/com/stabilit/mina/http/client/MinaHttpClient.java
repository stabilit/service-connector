...
public class MinaHttpClient {
	...
	public static void main(String[] args) throws Exception {
		...
		SCHttpClientHandler hanlder = new SCHttpClientHandler();
		...
		hanlder.sendMessage(session, msgSize);
	}

	public static class SCHttpClientHandler extends IoHandlerAdapter {

		public SCHttpClientHandler() {
		}
