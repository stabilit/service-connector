 ...
 * 
 */
package com.stabilit.sc.net.handler;
...
public class NettyWriteTimeoutHandler extends WriteTimeoutHandler {
	...
	private IConnectionListener callback;

	/**
	 * @param timer
	 * @param timeoutSeconds
	 */
	public NettyWriteTimeoutHandler(Timer timer, int timeoutSeconds, IConnectionListener callback) {
