...
public class SCMPCreateSessionCall extends SCMPCallAdapter {
	...
	public SCMPSession invoke() throws Exception {
		...
		this.call.setHeader(SCMPHeaderAttributeKey.IP_ADDRESS_LIST.getName(),localHost.getHostAddress());
		super.invoke();
	...
	public void setSessionInfo(String sessionInfo) {
		call.setHeader(SCMPHeaderAttributeKey.SESSION_INFO.getName(), sessionInfo);
	}
